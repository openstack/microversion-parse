...
latex_documents = [
  (master_doc, 'microversion-parse.tex', u'microversion-parse Documentation',
   u'OpenStack', 'manual'),
]
...
man_pages = [
    (master_doc, 'microversion-parse', u'microversion-parse Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'microversion-parse', u'microversion-parse Documentation',
   author, 'microversion-parse', 'One line description of project.',
   'Miscellaneous'),
]
